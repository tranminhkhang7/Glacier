                                ...
                                <div class="row justify-content-center">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="repeat_new_current_password" type="password" class="form-control" id="repeat_new_current_password" placeholder="Repeat New Password" required onkeyup="check()">
	...
	<script src="${pageContext.request.contextPath}/assets/js/custom.js"></script>
        <script>
            function check() {
                ...
                if (document.getElementById("new_current_password").value === document.getElementById("repeat_new_current_password").value && (length >5 && length <30)) {
