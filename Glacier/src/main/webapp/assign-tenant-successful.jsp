    ...
    <body style="font-family: 'Varela Round', sans-serif;">
        ...
        <div class="page sub-page">
            ...
            <section class="content" style="text-align: center">
                ...
                <br>
                <br>
                <h1 style="padding-bottom: 50px"> <i class="fa fa-check-circle" style="color: green"></i> Người thuê đã nhận phòng thành công!</h1>
                <h3><a class="title" href="./roomlist"><i class="fa fa-home" aria-hidden="true"></i> Trở về trang chủ</a></h3>
