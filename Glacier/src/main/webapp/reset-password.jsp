<%-- 
    ...
    Created on : May 31, 2022, 11:19:33 PM
    Author     : ASUS
--%>
...
<head>
	...
	<title>Đặt lại mật khẩu · Glacier</title>
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-md-4">
                            ...
                            <form method="POST" action="updatepassword" class="form clearfix">
                                <div class="form-group">
                                    <label for="password" class="col-form-label required">New Password</label>
                                    <input name="password" type="password" class="form-control" id="password" placeholder="Your New Password" required>
                                </div>
                                <!--end form-group-->
                                    <button style="float: right; width:100%" type="submit" class="btn btn-danger">Confirm to change password</button>
                                </form>
