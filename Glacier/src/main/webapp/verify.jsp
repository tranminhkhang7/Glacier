                        ...
                        <div class="row justify-content-center">
                            <div id="box1" class="col-md-6">                           
                                ...
                                <div class="" style="outline:2px solid green;color: black; background-color: rgb(252, 252, 252);min-height: 28vh; text-align: center;">                                
                                    <h2 style="padding-top: 35px; margin-bottom: 20px;">Xác thực email của bạn</h2>
                                    <p>Chúng tôi đã gửi email để xác thực danh tính của bạn</p>
                                    <p  style="padding-bottom: 10px">Hãy xem qua hộp thư qua email đã đăng ký để xác thức</p>
                                    <h3>Cảm ơn!</h3>
                                </div>
