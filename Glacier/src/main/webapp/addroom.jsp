                        ...
                        <form class="form form-submit" enctype="multipart/form-data" action="${pageContext.request.contextPath}/addroom" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input name="name" type="text" class="form-control" id="name" required maxlength="200">
                                        </div>
                                        <!--end form-group-->
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input name="area" type="number" class="form-control" id="area" placeholder="" required min="1" max="1000">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input name="price" type="number" class="form-control" id="price" required min="100000" max="100000000" step="1">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input name="deposit" type="number" class="form-control" id="deposit" required min="100000" max="100000000" step="1">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="details" id="details" class="form-control" rows="4" required maxlength="2500"></textarea>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <section>
                                ...
                                <div class="file-upload">
                                    <input required="" type="file" name="files[]" class="file-upload-input with-preview ignore" multiple title="Nhấp để chọn ảnh" maxlength="5" accept="jpg|png">
                            ...
                            <section>
                                ...
                                <div class="map height-300px" id="map-small">
                                    <iframe id="map"
                                            ...
                                            src="https://www.google.com/maps/embed/v1/place?key=AIzaSyCCYLuixh0QamoPxzrTZTCNGOtd0fwYQoQ&q=TP HCM" allowfullscreen>
                                    </iframe>
                                </div>
                            </section>
